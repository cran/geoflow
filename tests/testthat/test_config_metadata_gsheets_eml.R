# test_config_metadata_gsheets_eml.R
# Author: Emmanuel Blondel <emmanuel.blondel1@gmail.com>
#
# Description: Integration tests for config_metadata_gsheets_eml.json workflow
#=======================
require(geoflow, quietly = TRUE)
require(testthat)

cfg_file = system.file("extdata/workflows/config_metadata_gsheets_eml.json", package = "geoflow")
...
test_that("execute",{
  ...
  for(entity_dir in entity_dirs){
    ...
    expect_true(file.exists(file.path(EXEC, "entities", entity_dir, "metadata", paste0(entity_dir,"_EML.xml"))))
  }
})
